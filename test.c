...
# 21 "bulletchess/src/include/Python.h" 2
...
# 569 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/math.h" 3 4
...
# 23 "bulletchess/src/include/Python.h" 2
...
# 24 "bulletchess/src/include/Python.h" 2
# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/wchar.h" 1 3 4
# 74 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/wchar.h" 3 4
...
# 25 "bulletchess/src/include/Python.h" 2
...
# 39 "bulletchess/src/include/Python.h" 2
...
# 40 "bulletchess/src/include/Python.h" 2
...
# 1 "bulletchess/src/apply.h" 1


# 1 "bulletchess/src/move.h" 1


# 1 "bulletchess/src/board.h" 1


# 1 "bulletchess/src/piece.h" 1



# 1 "/Library/Developer/CommandLineTools/usr/lib/clang/15.0.0/include/stdbool.h" 1 3
# 5 "bulletchess/src/piece.h" 2


# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/errno.h" 1 3 4
# 8 "bulletchess/src/piece.h" 2

typedef uint8_t piece_type_t;
typedef uint8_t piece_color_t;
# 25 "bulletchess/src/piece.h"
typedef struct {
    piece_color_t color;
    piece_type_t type;
} piece_t;
...
# 4 "bulletchess/src/board.h" 2
# 1 "bulletchess/src/bitboard.h" 1
...
# 194 "bulletchess/src/bitboard.h"
...
# 5 "bulletchess/src/board.h" 2



# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/errno.h" 1 3 4
# 9 "bulletchess/src/board.h" 2
...
# 4 "bulletchess/src/move.h" 2
# 17 "bulletchess/src/move.h"
typedef struct {
 _Bool exists;
 u_int8_t value;
} optional_u_int8_t;
...
# 5 "bulletchess/src/bulletchess.h" 2
...
# 1 "bulletchess/src/fen.h" 1
# 15 "bulletchess/src/fen.h"
...
# 3 "bulletchess/src/bulletchess.c" 2
# 1 "bulletchess/src/rules.h" 1
# 11 "bulletchess/src/rules.h"
...
# 4 "bulletchess/src/bulletchess.c" 2
# 1 "bulletchess/src/hash.h" 1
...
# 5 "bulletchess/src/bulletchess.c" 2
# 1 "bulletchess/src/utils.h" 1
...
# 6 "bulletchess/src/bulletchess.c" 2

# 1 "bulletchess/src/pgn.h" 1


# 1 "bulletchess/src/dictionary/dict.h" 1
...
# 4 "bulletchess/src/pgn.h" 2
# 1 "bulletchess/src/date-parsing/date.h" 1
...
# 5 "bulletchess/src/pgn.h" 2
# 1 "bulletchess/src/tokenizer/tokenizer.h" 1
...
# 6 "bulletchess/src/pgn.h" 2
# 18 "bulletchess/src/pgn.h"
...
# 8 "bulletchess/src/bulletchess.c" 2
 ...
 for (square_t sq = 0; sq <= 63; sq++) {
  ...
  if (!py_square){
   for (square_t s2 = 0; s2 < sq; s2++)
    Py_TYPE(((PyObject*)((PySquares[s2]))))->tp_free((PyObject *)PySquares[s2]);
   return 0;
  }
  else {
   py_square->square = sq;
 ...
 for (piece_type_t pt = 3; pt <= 8; pt++){
  ...
  if (!py_piece_type) {
   for (piece_type_t pt2 = 3; pt2 < pt; pt2++)
    Py_TYPE(((PyObject*)((PySquares[pt2]))))->tp_free((PyObject *)PySquares[pt2]);
   return 0;
  }
  else {
...
static PyObject *PyPieceType_make(piece_type_t piece_type) {
 return (PyObject *)PieceTypeObjects[piece_type - 3];
}
...
static _Bool PyColors_init() {
 ...
 if (!BlackObject){
    Py_TYPE(((PyObject*)((WhiteObject))))->tp_free((PyObject *) WhiteObject);
  return 0;
 }
 WhiteObject->color = 1;
 BlackObject->color = 0;
...
static PyObject *PyColor_make(piece_color_t color) {
 switch (color) {
  case 1: return (PyObject *)WhiteObject;
  case 0: return (PyObject *)BlackObject;
  default:
...
static PyObject *PyMove_to_uci(PyObject *self) {
 char uci[10];
 if (write_uci(PyMove_get(self), uci)) {
...
PyMove_init(PyObject *self, PyObject *args, PyObject *kwargs){
  ...
  if (promote_to && !Py_IS_TYPE(((PyObject*)((promote_to))), (&PyPieceTypeType)) && !(((promote_to)) == ((&_Py_NoneStruct)))) {
   PyErr_Format(PyExc_TypeError, "Expected a PieceType or None for promote_to, got %S (%N)", promote_to, Py_TYPE(((PyObject*)((promote_to)))));
   return -1;
  }
...
static PyObject *
PyBoard_repr(PyObject *self, PyObject *_unused_args __attribute__((unused))){
 char fen_buffer[128];
 make_fen(PyBoard_board(self), fen_buffer);
...
static PyObject *PyBoard_copy(PyObject *self, PyObject *_unused_args __attribute__((unused))){
...
static PyMethodDef board_methods[] = {
    ...
    {"random", PyBoard_random, 0x0004 | 0x0020, ((void *)0)},
...
static int PyBoard_fullmove_set(PyObject *self, PyObject *val){
 ...
 if (32767 < raw) {
  char exp[30];
  __builtin___sprintf_chk (exp, 0, __builtin_object_size (exp, 2 > 1 ? 1 : 0), "a value < %d", 32767);
  PyTypeErr(exp, val);
  return -1;
 }
...
static PyGetSetDef Board_getset[] = {
   ...
   (getter)PyBoard_turn_get, (setter)PyBoard_turn_set, ((void *)0), ((void *)0)},
    {"fullmove_number",
   (getter)PyBoard_fullmove_get, (setter)PyBoard_fullmove_set, ((void *)0), ((void *)0)},
    {"halfmove_clock",
   (getter)PyBoard_halfmove_get, (setter)PyBoard_halfmove_set, ((void *)0), ((void *)0)},
    {"en_passant_square",
   (getter)PyBoard_ep_square, (setter)PyBoard_ep_set, ((void *)0), ((void *)0)},
    {"pawns",
   (getter)PyBoard_pawns, ((void *)0), ((void *)0), ((void *)0)},
    {"knights",
   (getter)PyBoard_knights, ((void *)0), ((void *)0), ((void *)0)},
    {"bishops",
   (getter)PyBoard_bishops, ((void *)0), ((void *)0), ((void *)0)},
    {"rooks",
   (getter)PyBoard_rooks, ((void *)0), ((void *)0), ((void *)0)},
    {"queens",
   (getter)PyBoard_queens, ((void *)0), ((void *)0), ((void *)0)},
    {"kings",
   (getter)PyBoard_kings, ((void *)0), ((void *)0), ((void *)0)},
  {"white",
   (getter)PyBoard_white, ((void *)0), ((void *)0), ((void *)0)},
  {"black",
   (getter)PyBoard_black, ((void *)0), ((void *)0), ((void *)0)},
  {"unoccupied",
   PyBoard_empty_bb, ((void *)0), ((void *)0), ((void *)0)},
...
static PyObject *PyUtils_srandom(PyObject *self, PyObject *arg){
 if ((((arg)) == ((&_Py_NoneStruct)))) {
  initstate(time(((void *)0)), rand_state, 256);
  return (&_Py_NoneStruct);
 }
...
# 1354 "bulletchess/src/bulletchess.c"
static PyObject *PyUtils_isolated_pawns (PyObject *self, PyObject *args){ if (!PyTypeCheck("Board", args, &PyBoardType)) return ((void *)0); return (PyObject *)PyBitboard_make(isolated_pawns(PyBoard_board(args))); }
static PyObject *PyUtils_backwards_pawns (PyObject *self, PyObject *args){ if (!PyTypeCheck("Board", args, &PyBoardType)) return ((void *)0); return (PyObject *)PyBitboard_make(backwards_pawns(PyBoard_board(args))); }
static PyObject *PyUtils_doubled_pawns (PyObject *self, PyObject *args){ if (!PyTypeCheck("Board", args, &PyBoardType)) return ((void *)0); return (PyObject *)PyBitboard_make(doubled_pawns(PyBoard_board(args))); }


static PyMethodDef PyUtilsMethods[] = {
 {"backwards_pawns", PyUtils_backwards_pawns, 0x0008, ((void *)0)},
 {"isolated_pawns", PyUtils_isolated_pawns, 0x0008, ((void *)0)},
 {"doubled_pawns", PyUtils_doubled_pawns, 0x0008, ((void *)0)},
 ...
 {"set_random_seed", PyUtils_srandom, 0x0008, ((void *)0)},
 {((void *)0), ((void *)0), 0, ((void *)0)}
};
...
# 1415 "bulletchess/src/bulletchess.c"
static PyObject* PyPGNResult_winner (PyObject *self) { PyPGNResultObject *obj = (PyPGNResultObject *)self; switch (obj->result) { case 0: return (PyObject *)((&_Py_NoneStruct)); case 1: return (PyObject *)(WhiteObject); case 2: return (PyObject *)(BlackObject); default: return (PyObject *)(&_Py_NoneStruct); }}
static PyObject* PyPGNResult_unknown (PyObject *self) { PyPGNResultObject *obj = (PyPGNResultObject *)self; switch (obj->result) { case 0: return (PyObject *)(((PyObject*)((&_Py_FalseStruct)))); case 1: return (PyObject *)(((PyObject*)((&_Py_FalseStruct)))); case 2: return (PyObject *)(((PyObject*)((&_Py_FalseStruct)))); default: return (PyObject *)((PyObject*)((&_Py_TrueStruct))); }}
static PyObject* PyPGNResult_draw (PyObject *self) { PyPGNResultObject *obj = (PyPGNResultObject *)self; switch (obj->result) { case 0: return (PyObject *)(((PyObject*)((&_Py_TrueStruct)))); case 1: return (PyObject *)(((PyObject*)((&_Py_FalseStruct)))); case 2: return (PyObject *)(((PyObject*)((&_Py_FalseStruct)))); default: return (PyObject *)((PyObject*)((&_Py_FalseStruct))); }}
static PyObject* PyPGNResult_to_str (PyObject *self) { PyPGNResultObject *obj = (PyPGNResultObject *)self; switch (obj->result) { case 0: return (PyObject *)PyUnicode_FromString("1/2-1/2"); case 1: return (PyObject *)PyUnicode_FromString("1-0"); case 2: return (PyObject *)PyUnicode_FromString("0-1"); default: return (PyObject *)"*"; }}



static PyGetSetDef PyPGNResult_getset[] = {
 {"winner" , (getter)PyPGNResult_winner, ((void *)0), ((void *)0)},
 {"unknown" , (getter)PyPGNResult_unknown, ((void *)0), ((void *)0)},
 {"draw" , (getter)PyPGNResult_draw, ((void *)0), ((void *)0)},
 {((void *)0)}
};
...
static PyObject *PyPGNGame_Alloc() {
 ...
 if (!obj) { return ((void *)0); PyErr_SetString(PyExc_MemoryError, "Could not allocate new PGNGame");};
 obj->game = PyMem_RawMalloc(sizeof(pgn_game_t));
 if (!obj->game) { return ((void *)0); PyErr_SetString(PyExc_MemoryError, "Could not allocate new PGNGame");};
 obj->game->moves = PyMem_RawMalloc(600 * sizeof(move_t));
 if (!obj->game->moves) { return ((void *)0); PyErr_SetString(PyExc_MemoryError, "Could not allocate new PGNGame");};
 pgn_tag_section_t *tags = PyMem_RawMalloc(sizeof(pgn_tag_section_t));
 if (!tags) { return ((void *)0); PyErr_SetString(PyExc_MemoryError, "Could not allocate new PGNGame");};
...
# 1502 "bulletchess/src/bulletchess.c"
static PyObject *PyObject_from_date(date_t date) {
 PyObject *tuple = PyTuple_New(3);
 if (!tuple) return ((void *)0);
 if (date.known_year) PyTuple_SET_ITEM(((PyObject*)((tuple))), (0), ((PyObject*)((PyLong_FromUnsignedLong(date.year))))); else PyTuple_SET_ITEM(((PyObject*)((tuple))), (0), ((PyObject*)(((&_Py_NoneStruct)))));;
 if (date.known_month) PyTuple_SET_ITEM(((PyObject*)((tuple))), (1), ((PyObject*)((PyLong_FromUnsignedLong(date.month))))); else PyTuple_SET_ITEM(((PyObject*)((tuple))), (1), ((PyObject*)(((&_Py_NoneStruct)))));;
 if (date.known_day) PyTuple_SET_ITEM(((PyObject*)((tuple))), (2), ((PyObject*)((PyLong_FromUnsignedLong(date.day))))); else PyTuple_SET_ITEM(((PyObject*)((tuple))), (2), ((PyObject*)(((&_Py_NoneStruct)))));;
 return tuple;
}

static PyObject *PyPGN_date (PyObject *self){ PyPGNGameObject *game = (PyPGNGameObject *)self; PyObject *obj = PyObject_from_date(game->game->tags->date); if (!obj){ return ((void *)0); } return obj;}
static PyObject *PyPGN_event (PyObject *self){ PyPGNGameObject *game = (PyPGNGameObject *)self; PyObject *obj = PyUnicode_FromString(game->game->tags->event); if (!obj){ return ((void *)0); } return obj;}
static PyObject *PyPGN_site (PyObject *self){ PyPGNGameObject *game = (PyPGNGameObject *)self; PyObject *obj = PyUnicode_FromString(game->game->tags->site); if (!obj){ return ((void *)0); } return obj;}
static PyObject *PyPGN_white_player (PyObject *self){ PyPGNGameObject *game = (PyPGNGameObject *)self; PyObject *obj = PyUnicode_FromString(game->game->tags->white_player); if (!obj){ return ((void *)0); } return obj;}
static PyObject *PyPGN_black_player (PyObject *self){ PyPGNGameObject *game = (PyPGNGameObject *)self; PyObject *obj = PyUnicode_FromString(game->game->tags->black_player); if (!obj){ return ((void *)0); } return obj;}
static PyObject *PyPGN_round (PyObject *self){ PyPGNGameObject *game = (PyPGNGameObject *)self; PyObject *obj = PyUnicode_FromString(game->game->tags->round); if (!obj){ return ((void *)0); } return obj;}
static PyObject *PyPGN_result (PyObject *self){ PyPGNGameObject *game = (PyPGNGameObject *)self; PyObject *obj = PyPGNResult_make(game->game->tags->result); if (!obj){ return ((void *)0); } return obj;}

static PyObject *PyPGN_moves(PyObject *self){
 PyPGNGameObject *game = (PyPGNGameObject *)self;
...
static PyObject *PyPGNFile_open(PyObject *unused, PyObject *args) {
 ...
 if (!file) {
  PyErr_Format(PyExc_FileNotFoundError, "Could not find PGN file with path %s", path);
  return ((void *)0);
 }
...
static PyObject *PyPGNFile_read_next_game(PyObject *self, PyObject *_unused_args __attribute__((unused))){
 ...
 switch (res) {
  case 0: return (PyObject *)game;
  case 1: {
   PyErr_SetString(PyExc_ValueError, err);
   return ((void *)0);
  }
  case 2: return (&_Py_NoneStruct);
 }
}
...
# 1682 "bulletchess/src/bulletchess.c"
__attribute__ ((visibility ("default"))) PyObject* PyInit__core(void) {
    if (PyType_Ready(&PyBoardType) < 0) return ((void *)0);
  if (PyType_Ready(&PyColorType) < 0) return ((void *)0);
  if (PyType_Ready(&PySquareType) < 0) return ((void *)0);
  if (PyType_Ready(&PyPieceTypeType) < 0) return ((void *)0);
  if (PyType_Ready(&PyPieceType) < 0) return ((void *)0);
  if (PyType_Ready(&PyMoveType) < 0) return ((void *)0);
  if (PyType_Ready(&PyBitboardType) < 0) return ((void *)0);
  if (PyType_Ready(&PyPGNFileType) < 0) return ((void *)0);
  if (PyType_Ready(&PyPGNGameType) < 0) return ((void *)0);
  if (PyType_Ready(&PyPGNResultType) < 0) return ((void *)0);
  initstate(time(((void *)0)), rand_state, 256);
  ...
  if (!PySquares_init()) {Py_DECREF(((PyObject*)((m)))); Py_DECREF(((PyObject*)((utils)))); Py_DECREF(((PyObject*)((pgn)))); return ((void *)0);};
  if (!PyPieceTypes_init()) {Py_DECREF(((PyObject*)((m)))); Py_DECREF(((PyObject*)((utils)))); Py_DECREF(((PyObject*)((pgn)))); return ((void *)0);};
  if (!PyColors_init()) {Py_DECREF(((PyObject*)((m)))); Py_DECREF(((PyObject*)((utils)))); Py_DECREF(((PyObject*)((pgn)))); return ((void *)0);};
  if (!PyPGNResults_init()) {Py_DECREF(((PyObject*)((m)))); Py_DECREF(((PyObject*)((utils)))); Py_DECREF(((PyObject*)((pgn)))); return ((void *)0);};
  ...
  if (!WHITE) {Py_DECREF(((PyObject*)((m)))); Py_DECREF(((PyObject*)((utils)))); Py_DECREF(((PyObject*)((pgn)))); return ((void *)0);};
  PyObject *BLACK = PyColor_make(0);
  if (!BLACK) {Py_DECREF(((PyObject*)((m)))); Py_DECREF(((PyObject*)((utils)))); Py_DECREF(((PyObject*)((pgn)))); return ((void *)0);};
  ...
  for (square_t sq = 0; sq <= 63; sq++) {
   ...
   if (!PySquare) {Py_DECREF(((PyObject*)((m)))); Py_DECREF(((PyObject*)((utils)))); Py_DECREF(((PyObject*)((pgn)))); return ((void *)0);};
  ...
  if (!PAWN) {Py_DECREF(((PyObject*)((m)))); Py_DECREF(((PyObject*)((utils)))); Py_DECREF(((PyObject*)((pgn)))); return ((void *)0);};
  PyObject *KNIGHT = PyPieceType_make(4);
  if (!KNIGHT) {Py_DECREF(((PyObject*)((m)))); Py_DECREF(((PyObject*)((utils)))); Py_DECREF(((PyObject*)((pgn)))); return ((void *)0);};
  PyObject *BISHOP = PyPieceType_make(5);
  if (!BISHOP) {Py_DECREF(((PyObject*)((m)))); Py_DECREF(((PyObject*)((utils)))); Py_DECREF(((PyObject*)((pgn)))); return ((void *)0);};
  PyObject *ROOK = PyPieceType_make(6);
  if (!ROOK) {Py_DECREF(((PyObject*)((m)))); Py_DECREF(((PyObject*)((utils)))); Py_DECREF(((PyObject*)((pgn)))); return ((void *)0);};
  PyObject *QUEEN = PyPieceType_make(7);
  if (!QUEEN) {Py_DECREF(((PyObject*)((m)))); Py_DECREF(((PyObject*)((utils)))); Py_DECREF(((PyObject*)((pgn)))); return ((void *)0);};
  PyObject *KING = PyPieceType_make(8);
  if (!KING) {Py_DECREF(((PyObject*)((m)))); Py_DECREF(((PyObject*)((utils)))); Py_DECREF(((PyObject*)((pgn)))); return ((void *)0);};
  ...
  for (int rank_num = 1; rank_num < 9; rank_num++) {
   ...
   if (!RANK) {Py_DECREF(((PyObject*)((m)))); Py_DECREF(((PyObject*)((utils)))); Py_DECREF(((PyObject*)((pgn)))); return ((void *)0);};
  ...
  for (int file_num = 0; file_num < 8; file_num++) {
   ...
   if (!FILEV) {Py_DECREF(((PyObject*)((m)))); Py_DECREF(((PyObject*)((utils)))); Py_DECREF(((PyObject*)((pgn)))); return ((void *)0);};
  ...
  if (!PieceTypes_List) {Py_DECREF(((PyObject*)((m)))); Py_DECREF(((PyObject*)((utils)))); Py_DECREF(((PyObject*)((pgn)))); return ((void *)0);};
